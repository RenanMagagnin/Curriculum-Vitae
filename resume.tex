...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{}{Renan Magagnin da Silva}
\address{Rua Moema, 208, Chácara das Pedras\\ Porto Alegre, 91330-500, RS, Brasil}
\mobile{+55 (51) 98296-8005}
%%% Social
\email{renanmagagnin@gmail.com}
\github{RenanMagagnin}
\homepage{renanmagagnin.com}
\linkedin{RenanMagagnin}
%%% Optionals
...
\makecvfooter
  {\today}
  {Renan Magagnin da Silva~~~·~~~Résumé}
  {}
